...
from ..endpoints import detect_axi_lite_interfaces, detect_axi_stream_interfaces

from veriforge.dsl import Expr, Module, sim_time
...
def generate_python_testbench(  # noqa: PLR0912, PLR0913, PLR0915
    ...
    *,
    ...
    if enhanced or plan is not None:
        if plan is None:
            from .planner import build_plan  # noqa: PLC0415
